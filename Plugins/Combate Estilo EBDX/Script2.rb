  ...
  class Battle::Scene::MenuBase
    BUTTON_HEIGHT = 46
    TEXT_BASE_COLOR   = Color.new(32, 32, 32) #Solo funciona cuando GET_MOVE_TEXT_COLOR_FROM_MOVE_BUTTON es false, este es el color base
    TEXT_SHADOW_COLOR = Color.new(80, 79, 79) #Solo funciona cuando GET_MOVE_TEXT_COLOR_FROM_MOVE_BUTTON es false, este es el color de las sombra
  end
  #==========================================================================================================================================================
class Battle::Scene::FightMenu < Battle::Scene::MenuBase
...
@buttons = Array.new(Pokemon::MAX_MOVES) do |i|  
  ...
  button.src_rect.height = @buttonBitmap.height / GameData::Type.count
  ...
  def refreshButtonNames
    ...
    @buttons.each_with_index do |button, i|
      ...
      # Obtener el nombre corto y truncarlo si excede los 9 caracteres
      move_name = moves[i].short_name
      short_name = move_name.length > 9 ? move_name[0...9] + "..." : move_name
  
      # Añadir el nombre truncado a la lista de posiciones de texto
      textPos.push([short_name, x, y, :center, base, shadow])
    end
  ...
  def refreshSelection
    ...
    if USE_GRAPHICS
      ...
      @buttons.each_with_index do |button, i|
        ...
        button.src_rect.y = GameData::Type.get(moves[i].display_type(@battler)).icon_position * @buttonBitmap.height / GameData::Type.count
