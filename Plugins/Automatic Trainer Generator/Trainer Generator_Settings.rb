...
module TrainerGenerator_Settings
    ...
    # Generations used (Updated to Generation 9)
    ...
    # Blacklist of Pokemon (Updated with Gen 5-9 Legendaries)
    BLACKLIST = [
        # Gen 1-4 Legendaries
        ...
        # Gen 5 Legendaries
        :COBALION, :TERRAKION, :VIRIZION, :TORNADUS, :THUNDURUS, :RESHIRAM, :ZEKROM, :LANDORUS, :KYUREM, :KELDEO, :MELOETTA, :GENESECT, :VICTINI,
        # Gen 6 Legendaries
        :XERNEAS, :YVELTAL, :ZYGARDE, :DIANCIE, :HOOPA, :VOLCANION,
        # Gen 7 Legendaries
        :TAPUKOKO, :TAPULELE, :TAPUBULU, :TAPUFINI, :COSMOG, :COSMOEM, :SOLGALEO, :LUNALA, :NIHILEGO, :BUZZWOLE, :PHEROMOSA, :XURKITREE, :CELESTEELA,
        ...
        # Gen 9 Legendaries
        :KORAIDON, :MIRAIDON, :WOCHIEN, :CHIENPAO, :TINGLU, :CHIYU, :TERAPAGOS, :PECHARUNT,
        :WALKINGWAKE, :IRONLEAVES, :GREATTUSK, :SCREAMTAIL, :BRUTEBONNET, :FLUTTERMANE, :SLITHERWING, :SANDYSHOCKS, :IRONTREADS, :IRONBUNDLE,
        :IRONHANDS, :IRONJUGULIS, :IRONTHORNS, :IRONMOTH, :IRONVALIANT, :ROARINGMOON, :GOUGINGFIRE, :RAGINGBOLT, :IRONBOULDER, :IRONCROWN
    ]
