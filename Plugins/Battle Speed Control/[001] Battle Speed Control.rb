...
module BattleSpeedControl
  ...
  def self.start_battle
    ...
    @battle_start_time = System.battle_speed_control_uptime
    @accelerated_time = 0
  end
  ...
  def self.update_time
    ...
    real_elapsed = System.battle_speed_control_uptime - @battle_start_time
...
module System
  class << self
    alias battle_speed_control_uptime uptime
